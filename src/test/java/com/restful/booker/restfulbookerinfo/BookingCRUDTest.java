...
import com.restful.booker.bestbuyinfo.BookingSteps;
...
public class BookingCRUDTest extends TestBase {
    static String firstname = "King" + TestUtils.getRandomValue();
    static String lastname = "khan" + TestUtils.getRandomValue();
